...
//  Serial.println(newBoardTemp);
  ...
  if (totalDistance - newDist < 5000 && breaksToggled == false){
    Wire.beginTransmission(slave_address);
    Wire.write(0x56);  // start byte
...
//  Serial.println(newDist);    
  ...
  root["velocity"] = "gps";
  root["distance"] = 1351824120;
  root["aceeleration"] = 6876;
  root["propulsion_temp"] = 78;
  root["breaking_temp"] = 68;
  root["motherboard_temp"] = 54;
  root["pod_state"] = 46;
  root["time_since_start"]=87;
